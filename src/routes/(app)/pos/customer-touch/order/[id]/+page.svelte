...
<div class="mx-auto max-w-7xl flex flex-col items-center justify-center p-2">
	...
	<div class="bg-card-container rounded-xl p-6 w-full shadow-lg mt-4 mb-8">
	...
	<div class="w-full flex flex-col items-center">
		...
		<div class="w-full grid grid-cols-3 justify-center gap-4">
			<a
				...
				class="flex justify-center items-center bg-non-merci-red text-white font-bold py-4 rounded-lg text-xl shadow-md"
			>
				{t('customerTouch.noThanksCta')}
			</a>
			<button
				class="flex justify-center items-center bg-action-green font-bold py-4 rounded-lg text-xl shadow-md"
			>
