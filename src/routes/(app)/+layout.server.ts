...
export async function load(params) {
	...
	return {
		...
		displayFullWidthHeader: runtimeConfig.displayFullWidthHeader,
		displayFullWidthNavbar: runtimeConfig.displayFullWidthNavbar,
		displayFullWidthFooter: runtimeConfig.displayFullWidthFooter,
		displayFullWidthProductPages: runtimeConfig.displayFullWidthProductPages,
		displayFullWidthCmsPages: runtimeConfig.displayFullWidthCmsPages,
		...
		...(cmsAgewall && {
			cmsAgewall,
			cmsAgewallData: await cmsFromContent({ desktopContent: cmsAgewall.content }, locals)
		}),
