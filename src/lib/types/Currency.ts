...
// Returns Price object with amount rounded to opt. specified precision
export function createPrice(
	amount: string | number,
	currency: Currency,
	useStoragePrecision = false
): Price {
	const precision = useStoragePrecision
		? STORAGE_FRACTION_DIGITS_PER_CURRENCY[currency]
