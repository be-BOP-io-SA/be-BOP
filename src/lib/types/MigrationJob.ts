...
export interface MigrationJob extends Timestamps {
	...
	/**
	 * Phases the connector chose to skip (e.g. settings/theme blocked by
	 * insufficient permissions on the source). Phase name → human reason.
	 */
	skippedPhases?: Record<string, string>;
}
