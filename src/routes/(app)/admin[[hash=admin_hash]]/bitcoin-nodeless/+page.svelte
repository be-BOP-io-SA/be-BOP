...
<p>
	Enter your public key. be-BOP will be able to generate new addresses and check funds received, but
...
<form method="post" class="flex flex-col gap-4">
	...
	<label class="form-label">
		...
		<p class="text-sm">
			...
			1 for each new address / bitcoin payment request on be-BOP. DO NOT CHANGE THIS VALUE unless
			you know what you are doing. It can lead to reusing existing addresses or creating addresses
			not detected by your wallet.
		</p>
	</label>
