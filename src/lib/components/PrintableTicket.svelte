<script lang="ts">
	...
	export let firstItemAddedAt: Date | undefined = undefined;
...
>
	...
	<!-- Date/time information -->
	{#if firstItemAddedAt || orderCreatedAt}
		<div class="ticket-dates">
			{#if firstItemAddedAt}
				<div>
					{t('pos.midTicket.poolFirstItemAdded', {
						date: format(firstItemAddedAt, 'dd/MM/yyyy'),
						time: format(firstItemAddedAt, 'HH:mm:ss')
					})}
				</div>
			{/if}
			{#if orderCreatedAt}
