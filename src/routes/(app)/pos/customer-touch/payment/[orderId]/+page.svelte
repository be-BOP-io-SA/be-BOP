	...
	{#if data.order.status === 'pending'}
		...
		<div class="w-full grid grid-cols-[min-content_auto] gap-4">
			<button
				...
				class="bg-abandon-dark text-white flex justify-center text-xl font-semibold rounded-lg p-4"
			>
...
<style>
	/* Custom background color for the Abandon button (from previous designs) */
	.bg-abandon-dark {
