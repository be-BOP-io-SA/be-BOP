...
{#if tabSelectModalOpen}
	<div class="fixed inset-0 bg-black/50 flex items-center justify-center z-50">
		<div class="bg-white rounded-xl shadow-lg w-[400px] max-h-[90vh] overflow-y-auto p-6 relative">
			<button
			...
			<section class="mb-6">
				...
				<div class="grid grid-cols-3 gap-2">
					{#each tabs.tables as table}
						<button
							class="touchScreen-product-cta text-white rounded-md py-2 hover:bg-purple-600"
