<script lang="ts">
	...
	/**
	 * Optional precision for displaying the amount. If provided, uses this precision
	 * instead of the default FRACTION_DIGITS_PER_CURRENCY.
	 */
	...
	// Determine decimal places based on currency and optional precision
	$: maximumFractionDigits = precision ?? FRACTION_DIGITS_PER_CURRENCY[displayedCurrency];
