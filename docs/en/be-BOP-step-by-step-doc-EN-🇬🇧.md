...
**Public HTTP API (PoS concentrator):** see [Public HTTP API](public-http-api.md) to expose catalog / order write / paid-order read to an external till. Create keys in Admin → API Keys. Interactive contract: `/api/v1/docs`.
