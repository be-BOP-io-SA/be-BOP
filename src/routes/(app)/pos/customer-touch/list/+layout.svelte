...
<div class="mx-auto max-w-7xl px-2">
	...
	<div class="grid grid-cols-[min-content_auto] gap-2">
		<aside class="bg-sidebar-dark text-white flex flex-col rounded-lg pt-2">
			<nav class="flex-1">
				<a
		...
		{#if $page.url.pathname !== '/pos/customer-touch/list/drop'}
			<button
				...
				class="bg-sidebar-dark text-white flex justify-center text-xl font-semibold rounded-lg p-4 mb-8"
			>
				{t('customerTouch.cta.abandonment')}
			</button>
			{#if priceInfo.totalPrice === 0}
				<button
					class="bg-bottom-bar-green text-black flex justify-center text-xl rounded-lg font-semibold p-4 mb-8"
